 ...
 */
   ...
   *  </code>
   */
  class Google_Games_AchievementsServiceResource extends Google_ServiceResource {
   ...
   *  </code>
   */
  class Google_Games_ApplicationsServiceResource extends Google_ServiceResource {
   ...
   *  </code>
   */
  class Google_Games_PlayersServiceResource extends Google_ServiceResource {
    ...
    public function get($playerId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new Google_Games_Player($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class Google_Games_RoomsServiceResource extends Google_ServiceResource {
   ...
   *  </code>
   */
  class Google_Games_ScoresServiceResource extends Google_ServiceResource {
...
class Google_GamesService extends Google_Service {
  ...
  public function __construct(Google_Client $client) {
    ...
    $this->players = new Google_Games_PlayersServiceResource($this, $this->serviceName, 'players', json_decode('{"methods": {"get": {"id": "games.players.get", "path": "players/{playerId}", "httpMethod": "GET", "parameters": {"playerId": {"type": "string", "required": true, "location": "path"}}, "response": {"$ref": "Player"}, "scopes": ["https://www.googleapis.com/auth/plus.login"]}}}', true));
...
class Google_LeaderboardEntry extends Google_Model {
  ...
  public function setPlayer(Google_Games_Player $player) {
    $this->player = $player;
  }
...
class Google_Games_Player extends Google_Model {
  public $avatarImageUrl;
  public $displayName;
  public $kind;
  public $playerId;
