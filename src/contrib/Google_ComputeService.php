 ...
 */
  ...
  class Google_AddressesServiceResource extends Google_ServiceResource {
    ...
    public function get($project, $region, $address, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new Google_Compute_Address($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $project Name of the project scoping this request.
     * @param string $region Name of the region scoping this request.
     * @param Google_Compute_Address $postBody
     * @param array $optParams Optional parameters.
     * @return Google_Operation
     */
    public function insert($project, $region, Google_Compute_Address $postBody, $optParams = array()) {
   ...
   *  </code>
   */
  class Google_Compute_InstancesServiceResource extends Google_ServiceResource {
    ...
    public function get($project, $zone, $instance, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new Google_Compute_Instance($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $project Name of the project scoping this request.
     * @param string $zone Name of the zone scoping this request.
     * @param Google_Compute_Instance $postBody
     * @param array $optParams Optional parameters.
     * @return Google_Operation
     */
    public function insert($project, $zone, Google_Compute_Instance $postBody, $optParams = array()) {
      $params = array('project' => $project, 'zone' => $zone, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     * @param string $zone Name of the zone scoping this request.
     * @param string $instance Name of the instance scoping this request.
     * @param Google_Compute_Metadata $postBody
     * @param array $optParams Optional parameters.
     * @return Google_Operation
     */
    public function setMetadata($project, $zone, $instance, Google_Compute_Metadata $postBody, $optParams = array()) {
      $params = array('project' => $project, 'zone' => $zone, 'instance' => $instance, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class Google_Compute_ProjectsServiceResource extends Google_ServiceResource {
     ...
     * @return Google_Operation
     */
    public function setCommonInstanceMetadata($project, Google_Compute_Metadata $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
...
class Google_Compute_Address extends Google_Model {
  public $address;
...
class Google_Compute_Instance extends Google_Model {
  public $canIpForward;
  public $creationTimestamp;
  public $description;
  ...
  public function setMetadata(Google_Compute_Metadata $metadata) {
...
class Google_Compute_Metadata extends Google_Model {
  public $fingerprint;
...
class Google_Operation extends Google_Model {
  ...
  public function setError(Google_Compute_OperationError $error) {
    $this->error = $error;
  }
...
class Google_Compute_OperationError extends Google_Model {
...
class Google_Project extends Google_Model {
  ...
  public $quotas;
  public $selfLink;
  public function setCommonInstanceMetadata(Google_Compute_Metadata $commonInstanceMetadata) {
